...
export default function Profile$() {
  ...
  const data = async() => {
      const getData = await axios.get('https://jsonplaceholder.typicode.com/todos/1').then(res => res.data)
      setUsers(getData);
  }
                    ...
                    <div class="col-lg-6">
                      <div class="about-text go-to">
                        ...
                        <p>
                          ...
                          is to design digital user experiences through the bold
                  ...
                  <div class="counter">
                    <div class="row">
                      ...
                      <div class="col-6 col-lg-3">
                        ...
                        <Delete onClick={handleDelete(m.id)} />
                      </div>
                    </div>
                  </div>
                </div>
