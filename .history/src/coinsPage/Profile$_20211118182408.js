              ...
              <div class="row align-items-center flex-row-reverse">
                <div class="col-lg-6">
                  <div class="about-text go-to">
                    <h3 class="dark-color">About Omar</h3>
                    <h6 class="theme-color lead">
                      Designer &amp; based in Tashkent
                    </h6>
                    <p>
                      I <mark>Freelancer</mark> services for customers of all
                      ...
                      <div class="row align-items-center flex-row-reverse">
                        <div class="col-lg-6">
                          <div class="about-text go-to">
                            ...
                            <h6 class="theme-color lead">
                              {m?.job} &amp; based in {m.address}
                            </h6>
                            <p>
                              I <mark>{m?.job}</mark> services for customers of
                              ...
                              through the bold interface and meaningful
                              interactions.
                            </p>
                            <div class="row about-list">
                              <div class="col-md-6">
