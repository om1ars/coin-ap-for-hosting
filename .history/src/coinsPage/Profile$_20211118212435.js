...
import {
  deleteDbuser,
  fetchAsnycUser,
} from "../redux/reducers/settingsUserSlice";
import "./Profile$.scss";
...
//       .post("https://jsonplaceholder.typicode.com/users", {title: 'posted'})
//       .then((res) => res.data);
//     setUsers(getData);
//   };

  const testUser = useSelector((state) => state.dbUsers.user);
            ...
            <div class="row align-items-center flex-row-reverse">
              <div class="col-lg-6">
                <div class="about-text go-to">
                  <h3 class="dark-color">About {user.name}</h3>
                  <h6 class="theme-color lead">
                    &amp; based in {user.address.geolocation}
                  </h6>
                  <p>
